...
//		this.camera.zoom = (Gdx.graphics.getWidth() / Gdx.graphics.getHeight()) * (GAME_SCREEN_ZOOM / ((Gdx.graphics.getWidth() / Gdx.graphics.getHeight())));
//
//		// Set loading screen
...
//          if(currentScreen != null) currentScreen.resize(arg0, arg1);
//    }
//
//    @Override
//    public void resume() {
